...
data modify storage n_plib:storage macro.end_pos set from storage n_plib:storage tempPosEnd
data modify entity @s data.n_plib set from storage n_plib:storage macro
...
execute store result score @s n_plib.loop_step run scoreboard players remove @s n_plib.loop_sentinel 1
...
execute if score @s n_plib.loop_sentinel matches 600.. store result score @s n_plib.loop_step run scoreboard players set @s n_plib.loop_sentinel 600

scoreboard players operation @s n_plib.loop_step /= #steps n_plib.temp
scoreboard players set #loop n_plib.temp 0

$execute if score @s n_plib.loop_sentinel matches 1.. at @s run function n_plib:zprivate/lightning/beizer_d/loop {command:"$(command)"}