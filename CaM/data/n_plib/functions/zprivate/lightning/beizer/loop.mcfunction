...
$execute unless score #delay n_plib.temp > @s n_plib.loop facing entity @s feet run function n_plib:zprivate/lightning/beizer/light_loop {command:"$(command)"}

$execute if score @s n_plib.loop < @s n_plib.loop_sentinel at @s run function n_plib:zprivate/lightning/beizer/loop {command:"$(command)"}