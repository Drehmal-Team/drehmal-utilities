...
scoreboard players operation #math.quaternion.out.w ntils.API /= #2^15.5 ntils.z.const
...
scoreboard players operation #math.quaternion.out.z ntils.API /= #-2^15.5 ntils.z.const
...
scoreboard players operation #math.quaternion.out.y ntils.API /= #2^15.5 ntils.z.const
...
scoreboard players operation #math.quaternion.out.x ntils.API /= #2^15.5 ntils.z.const