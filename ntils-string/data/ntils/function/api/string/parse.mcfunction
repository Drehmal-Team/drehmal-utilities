...
execute store result score #loop ntils.z.string.temp run data get storage ntils:api string.parse.in
scoreboard players operation #loop ntils.z.string.temp /= #8 ntils.z.const
...
execute if score #loop ntils.z.string.temp matches 1.. run function ntils:z/string/parse/loop
