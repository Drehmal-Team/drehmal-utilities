...
#
# INPUT:
#   The time that is generated by this function is based on the internal unix timestamp. However, the following scoreboard flags exist:
...
execute store result score #time.get.realtime.hour ntils.API store result score #time.get.realtime.minute ntils.API store result score #time.get.realtime.second ntils.API run scoreboard players operation #day_of_year ntils.z.time.temp = #CURRENT_UNIX_TIME# ntils.z.global

scoreboard players operation #time.get.realtime.minute ntils.API /= #60 ntils.z.const
execute store result storage ntils:api time.get.realtime.out.minute int 1 run scoreboard players operation #time.get.realtime.minute ntils.API %= #60 ntils.z.const

execute store result storage ntils:api time.get.realtime.out.second int 1 run scoreboard players operation #time.get.realtime.second ntils.API %= #60 ntils.z.const
...
execute store result score #time.get.realtime.year ntils.API run scoreboard players remove #day_of_year ntils.z.time.temp 730
...
execute store result storage ntils:api time.get.realtime.out.day.value int 1 store result score #time.get.realtime.day ntils.API run scoreboard players operation #day_of_year ntils.z.time.temp += #mod ntils.z.time.temp
execute store result score #time.get.realtime.month ntils.API run data get storage ntils:api time.get.realtime.out.month.value

scoreboard players operation #time.get.realtime.year ntils.API /= #1461 ntils.z.const
scoreboard players operation #time.get.realtime.year ntils.API *= #4 ntils.z.const
scoreboard players add #time.get.realtime.year ntils.API 1972

execute store result storage ntils:api time.get.realtime.out.year int 1 run scoreboard players operation #time.get.realtime.year ntils.API += #add ntils.z.time.temp
