...
execute store result storage ntils:z time.get.sunpos.macro.t int 1 store result score #t ntils.temp run time query daytime
...
execute if score #t ntils.temp matches 6000..18000 run data modify storage ntils:api time.get.sunpos.out.yaw set value 90f
