...
execute store result storage ntils:z tempPos[0] double 0.001 run scoreboard players operation #math.bz.3.i.out.x ntils.API += #rand ntils.z.temp

execute store result score #rand ntils.z.temp run random value -750..750
execute store result storage ntils:z tempPos[1] double 0.001 run scoreboard players operation #math.bz.3.i.out.y ntils.API += #rand ntils.z.temp

execute store result score #rand ntils.z.temp run random value -750..750
execute store result storage ntils:z tempPos[2] double 0.001 run scoreboard players operation #math.bz.3.i.out.z ntils.API += #rand ntils.z.temp
