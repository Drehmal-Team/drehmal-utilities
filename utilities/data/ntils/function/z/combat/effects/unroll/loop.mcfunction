data modify storage ntils:z effects.unroll.tmp set from storage ntils:z effects.unroll.in
...
execute unless data storage ntils:z effects.unroll.in.hidden_effect run return 1
data modify storage ntils:z effects.unroll.in set from storage ntils:z effects.unroll.in.hidden_effect
