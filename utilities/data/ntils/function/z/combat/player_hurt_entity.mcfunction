...
execute if entity @s[advancements={ntils:z/player_hurt_entity={arthropod=true}}] store result score #dam_mod ntils.z.temp run data get storage ntils:z tempMainhand.components."minecraft:enchantments".levels."minecraft:bane_of_athropods" 25
