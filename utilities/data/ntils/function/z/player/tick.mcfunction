...
execute unless entity @s[scores={ntils.z.pdata.id=1..,ntils.API.id=1..}] run function ntils:z/player/id/check
execute store result storage ntils:z player.tick.macro.id int 1 run scoreboard players get @s ntils.z.pdata.id
