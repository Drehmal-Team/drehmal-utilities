...
execute store success score #diff ntils.temp run data modify storage ntils:z tempString set value "scr|"
execute if score #diff ntils.temp matches 0 run function ntils:z/tag_scores/foundscore
