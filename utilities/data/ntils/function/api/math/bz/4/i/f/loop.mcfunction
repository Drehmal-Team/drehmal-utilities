...
execute store result storage ntils:api math.bz.4.i.out[0] double 0.001 store result score #math.bz.4.i.out.x ntils.API run scoreboard players operation #math.bz.4.i.base.x ntils.z.math.bz.4.temp += #math.bz.4.i.vec_s.x ntils.z.math.bz.4.temp
...
execute store result storage ntils:api math.bz.4.i.out[1] double 0.001 store result score #math.bz.4.i.out.y ntils.API run scoreboard players operation #math.bz.4.i.base.y ntils.z.math.bz.4.temp += #math.bz.4.i.vec_s.y ntils.z.math.bz.4.temp
...
execute store result storage ntils:api math.bz.4.i.out[2] double 0.001 store result score #math.bz.4.i.out.z ntils.API run scoreboard players operation #math.bz.4.i.base.z ntils.z.math.bz.4.temp += #math.bz.4.i.vec_s.z ntils.z.math.bz.4.temp
