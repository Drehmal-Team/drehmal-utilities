...
# Once an iteration has been started, calling math/bz/3/i/s/loop will perform one iteration along the beizer curve. Once the amount of iterations becomes equal to
...
execute store result storage ntils:api math.bz.3.i.out[0] double 0.001 store result score #math.bz.3.i.out.x ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.x = #math.bz.3.i.in.a.x ntils.API
execute store result storage ntils:api math.bz.3.i.out[1] double 0.001 store result score #math.bz.3.i.out.y ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.y = #math.bz.3.i.in.a.y ntils.API
execute store result storage ntils:api math.bz.3.i.out[2] double 0.001 store result score #math.bz.3.i.out.z ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.z = #math.bz.3.i.in.a.z ntils.API