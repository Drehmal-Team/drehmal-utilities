# MATH/BZ/3/I/S/LOOP
#
# Iterates a single step along the beizer curve initialized by the math/bz/3/i/s/loop function and sets the output scores/data.
...
execute store result storage ntils:api math.bz.3.i.out[0] double 0.001 store result score #math.bz.3.i.out.x ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.x += @s ntils.z.math.bz.3.i.vec_s.x
...
execute store result storage ntils:api math.bz.3.i.out[1] double 0.001 store result score #math.bz.3.i.out.y ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.y += @s ntils.z.math.bz.3.i.vec_s.y
...
execute store result storage ntils:api math.bz.3.i.out[2] double 0.001 store result score #math.bz.3.i.out.z ntils.API run scoreboard players operation @s ntils.z.math.bz.3.i.base.z += @s ntils.z.math.bz.3.i.vec_s.z
